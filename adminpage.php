...
<html lang="en">
        ...
        <div class="row">
          ...
          <div class="col-6">
            <p class="mb-0 float-right">
              ...
              <span><a href="mialto:rocklifebehappy@gmail.com"><span class="icon-envelope mr-2"></span><span class="d-none d-lg-inline-block">ncitproject@gmail.com</span></a></span>
            </p>
  ...
  <div class="space"></div>
  <div class="login">
    <form method="post" action="adminvalidation.php" name="login" id="login">
      <input type="text" name="name" placeholder="Enter owner id" required="required"><br>
      <input type="password" name="password" placeholder="Enter password" required="required"><br>
      <input type="submit" value="submit" name="admin" class="submit"><br>
    </form>
  </div>
  <div class="space"></div>
</main>
