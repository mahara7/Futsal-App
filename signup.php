        ...
        <div class="row">
          ...
          <div class="col-6">
            <p class="mb-0 float-right">
              ...
              <span><a href="#"><span class="icon-envelope mr-2"></span><span class="d-none d-lg-inline-block">ncitproject@gmail.com</span></a></span>
            </p>
...
<br><br>
  ...
  <div class="space"></div>
  <div class="login">
    <form method="post" action="signupvalidation.php" name="signup" id="signup">
      <input type="text" name="name" placeholder="Enter your name" required="required"><br>
      <input type="number" name="mobile" placeholder="Enter phone number" required="required"><br>
      ...
      <input type="password" name="password" placeholder="Enter the password" required="required"><br>
      <input type="submit" class="submit" value="submit" class="submit"><br>
    </form>
  </div>
  <div class="space"></div>
</main>
